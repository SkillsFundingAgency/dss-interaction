...
namespace NCS.DSS.Interaction.Tests
{
    ...
    public class GetInteractionHttpTriggerTest
    {
        ...
        [Test]
        public async Task GetInteractionHttpTrigger_ReturnsStatusCodeNotFound_WhenCustomerDoesNotExist()
        {
            // Arrange
            _httpRequestMessageHelper.Setup(x => x.GetDssTouchpointId(_request)).Returns("0000000001");
        ...
        [Test]
        public async Task GetInteractionHttpTrigger_ReturnsStatusCodeNotFound_WhenInteractionDoesNotExist()
        {
            // Arrange
            _httpRequestMessageHelper.Setup(x => x.GetDssTouchpointId(_request)).Returns("0000000001");
